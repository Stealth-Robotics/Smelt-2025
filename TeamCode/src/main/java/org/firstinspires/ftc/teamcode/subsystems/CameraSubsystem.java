...
import static org.firstinspires.ftc.teamcode.usablethings.Pipeline.*;
...
public class CameraSubsystem extends StealthSubsystem{
     ...
     */
    public CameraSubsystem(@NonNull HardwareMap hardwareMap) {
 ...
 */
     ...
     */
        ...
        // Rotate the limelight by LL_ANGLE_DELTA to get the robot's heading
        ...
        return new Pose(
                -position.x + (FIELD_SIZE_X_INCHES / 2.0),
                (FIELD_SIZE_Y_INCHES / 2.0) - (-position.y),
